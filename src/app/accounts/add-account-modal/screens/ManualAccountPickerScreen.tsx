...
interface ManualAccountPickerScreenProps {
...
export default function ManualAccountPickerScreen({
  supportedAccounts,
  searchQuery,
  setSearchQuery,
  onAccountSelect,
}: ManualAccountPickerScreenProps) {
              ...
              <div className="relative">
                ...
                >
                  <Image
                    ...
                    width={96}
                    height={96}
                    alt={`${account.institutionName} ${account.accountName}`}
